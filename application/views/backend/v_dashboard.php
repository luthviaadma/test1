...
<?php 
    ...
    $query2=$this->db->query("SELECT * FROM orders");
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik Pengunjung bulan ini</h3>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                          <canvas id="canvas" width="970" height="370"></canvas>
                  </div>
                  <!-- /.chart-responsive -->
                </div>
                <!-- /.col -->
