...
<head>
  ...
  <title>Ngetour | Paket Tour</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span> Tambah Paket</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                    <th>Gambar</th>
                    <th>Paket</th>
                    <th style="text-align: right;">Tarif Jakarta</th>
                    <th style="text-align: right;">Tarif Bandung</th>
...
<div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/paket_tour/simpan_paket'?>" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="control-label col-xs-2" >Tarif Jakarta</label>
                <div class="col-xs-8">
                    <input name="hrg_dewasa" class="form-control" type="text" placeholder="Tarif Jakarta" required>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-xs-2" >Tarif Bandung</label>
                <div class="col-xs-8">
                    <input name="hrg_anak" class="form-control" type="text" placeholder="Tarif Bandung" required>
                </div>
            </div>
  ...
  $(function () {
    ...
    <?php if($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Paket Tour Berhasil Disimpan.",
