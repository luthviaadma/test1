...
<tr>
    <td><img src="<?php echo base_url().'theme/images/placeholders/logo.png'?>"/></td>
</tr>
</table>
...
<tr>
    <td colspan="4" style="width:700px;paddin-left:20px;"><center>INVOICE</center><br/></td>
                        ...
                        <tr>
                            <td style="padding-left:5px;">Harga Jakarta</td>
                        ...
                        <tr>
                            <td style="padding-left:5px;">Harga Bandung</td>
...
<tbody>
            ...
            <tr>
                ...
                <td style="text-align:center;"><?php echo 'Rp. '.number_format( $b['total']); ?></td>
